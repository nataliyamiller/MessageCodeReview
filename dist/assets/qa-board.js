...
define('qa-board/adapters/application', ['exports', 'ember', 'emberfire/adapters/firebase'], function (exports, Ember, FirebaseAdapter) {
...
define('qa-board/app', ['exports', 'ember', 'ember/resolver', 'ember/load-initializers', 'qa-board/config/environment'], function (exports, Ember, Resolver, loadInitializers, config) {
...
define('qa-board/components/app-version', ['exports', 'ember-cli-app-version/components/app-version', 'qa-board/config/environment'], function (exports, AppVersionComponent, config) {
...
define('qa-board/components/bs-accordion-item', ['exports', 'ember', 'ember-bootstrap/components/bs-accordion-item'], function (exports, Ember, component) {
...
define('qa-board/components/bs-accordion', ['exports', 'ember', 'ember-bootstrap/components/bs-accordion'], function (exports, Ember, component) {
...
define('qa-board/components/bs-alert', ['exports', 'ember', 'ember-bootstrap/components/bs-alert'], function (exports, Ember, component) {
...
define('qa-board/components/bs-button-group', ['exports', 'ember', 'ember-bootstrap/components/bs-button-group'], function (exports, Ember, bsButtonGroup) {
...
define('qa-board/components/bs-button', ['exports', 'ember', 'ember-bootstrap/components/bs-button'], function (exports, Ember, bsButton) {
...
define('qa-board/components/bs-collapse', ['exports', 'ember', 'ember-bootstrap/components/bs-collapse'], function (exports, Ember, component) {
...
define('qa-board/components/bs-dropdown-button', ['exports', 'ember', 'ember-bootstrap/components/bs-dropdown-button'], function (exports, Ember, component) {
...
define('qa-board/components/bs-dropdown-menu', ['exports', 'ember', 'ember-bootstrap/components/bs-dropdown-menu'], function (exports, Ember, component) {
...
define('qa-board/components/bs-dropdown-toggle', ['exports', 'ember', 'ember-bootstrap/components/bs-dropdown-toggle'], function (exports, Ember, component) {
...
define('qa-board/components/bs-dropdown', ['exports', 'ember', 'ember-bootstrap/components/bs-dropdown'], function (exports, Ember, component) {
...
define('qa-board/components/bs-form-element', ['exports', 'ember', 'ember-bootstrap/components/bs-form-element'], function (exports, Ember, component) {
...
define('qa-board/components/bs-form-group', ['exports', 'ember', 'ember-bootstrap/components/bs-form-group'], function (exports, Ember, component) {
...
define('qa-board/components/bs-form', ['exports', 'ember', 'ember-bootstrap/components/bs-form'], function (exports, Ember, component) {
...
define('qa-board/components/bs-input', ['exports', 'ember', 'ember-bootstrap/components/bs-input'], function (exports, Ember, component) {
...
define('qa-board/components/bs-select', ['exports', 'ember', 'ember-bootstrap/components/bs-select'], function (exports, Ember, component) {
...
define('qa-board/components/bs-textarea', ['exports', 'ember', 'ember-bootstrap/components/bs-textarea'], function (exports, Ember, component) {
...
define('qa-board/components/new-answer', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    actions: {
      ...
      saveAnswer: function saveAnswer() {
        ...
        this.set('anwerContent', ''), this.set('answerAuthor', ''), this.set('addNewAnswer', false), this.sendAction('saveAnswer', params);
      }
    }
  });

});
define('qa-board/components/new-question', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    actions: {
      ...
      saveQuestion: function saveQuestion() {
        ...
        this.set('content', ''), this.set('questionAuthor', ''), this.set('description', ''), this.set('addNewQuestion', false), this.sendAction('saveQuestion', params);
      }
    }
  });

});
define('qa-board/components/question-detail', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/components/question-tile', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/components/update-question', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    actions: {
      ...
      updateQuestion: function updateQuestion(question) {
        ...
        this.set('content', ''), this.set('questionAuthor', ''), this.set('description', ''), this.set('updateQuestionForm', false);
        this.sendAction('updateQuestion', question, params);
      }
    }
  });
...
define('qa-board/controllers/array', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/controllers/object', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/helpers/current-date', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Helper.helper(currentDate);

});
define('qa-board/helpers/format-date', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Helper.helper(formatDate);

});
define('qa-board/helpers/is-equal', ['exports', 'ember-bootstrap/helpers/is-equal'], function (exports, is_equal) {
...
define('qa-board/helpers/is-not', ['exports', 'ember-bootstrap/helpers/is-not'], function (exports, is_not) {
...
define('qa-board/helpers/read-path', ['exports', 'ember-bootstrap/helpers/read-path'], function (exports, read_path) {
...
define('qa-board/initializers/app-version', ['exports', 'ember-cli-app-version/initializer-factory', 'qa-board/config/environment'], function (exports, initializerFactory, config) {
...
define('qa-board/initializers/emberfire', ['exports', 'emberfire/initializers/emberfire'], function (exports, EmberFireInitializer) {
...
define('qa-board/initializers/export-application-global', ['exports', 'ember', 'qa-board/config/environment'], function (exports, Ember, config) {
...
define('qa-board/initializers/load-bootstrap-config', ['exports', 'qa-board/config/environment', 'ember-bootstrap/config'], function (exports, ENV, Config) {
...
define('qa-board/models/answer', ['exports', 'ember-data'], function (exports, DS) {

  'use strict';

  exports['default'] = DS['default'].Model.extend({
    answerContent: DS['default'].attr(),
    answerAuthor: DS['default'].attr(),
    date_added: DS['default'].attr(),
    votes: 0,
    question: DS['default'].belongsTo('question', { async: true })
  });

});
define('qa-board/models/question', ['exports', 'ember-data'], function (exports, DS) {
...
define('qa-board/router', ['exports', 'ember', 'qa-board/config/environment'], function (exports, Ember, config) {
...
define('qa-board/routes/about', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/routes/index', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/routes/question', ['exports', 'ember'], function (exports, Ember) {
...
define('qa-board/services/firebase', ['exports', 'emberfire/services/firebase', 'qa-board/config/environment'], function (exports, Firebase, config) {
...
define('qa-board/templates/about', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/about.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("This is a website where you can ask questions and get answers! Finally!");
...
define('qa-board/templates/application', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/application.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Questions and Answers Message Board");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ["block","link-to",["application"],[],0,null,["loc",[null,[4,16],[4,58]]]],
        ["block","link-to",["about"],[],1,null,["loc",[null,[5,16],[5,53]]]],
...
define('qa-board/templates/components/bs-accordion-item', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/bs-accordion-item.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/bs-alert', ['exports'], function (exports) {
      ...
      var child0 = (function() {
        return {
          meta: {
            ...
            "moduleName": "qa-board/templates/components/bs-alert.hbs"
          },
          arity: 0,
          cachedFragment: null,
          hasRendered: false,
...
define('qa-board/templates/components/bs-button', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/bs-button.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/bs-form-group', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/bs-form-group.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/bs-form', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/components/bs-form.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('qa-board/templates/components/bs-select', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/bs-select.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/errors', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/errors.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/feedback-icon', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/feedback-icon.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/horizontal/checkbox', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/components/form-element/horizontal/checkbox.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('qa-board/templates/components/form-element/horizontal/default', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/horizontal/default.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/horizontal/select', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/horizontal/select.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/horizontal/select2', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/horizontal/select2.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/horizontal/textarea', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/horizontal/textarea.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/inline/checkbox', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/components/form-element/inline/checkbox.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('qa-board/templates/components/form-element/inline/default', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/inline/default.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/inline/select', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/inline/select.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/inline/textarea', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/inline/textarea.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/vertical/checkbox', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/components/form-element/vertical/checkbox.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('qa-board/templates/components/form-element/vertical/default', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/vertical/default.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/vertical/select', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/vertical/select.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/form-element/vertical/textarea', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/form-element/vertical/textarea.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
...
define('qa-board/templates/components/new-answer', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/new-answer.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el4,"for","answerContent");
          var el5 = dom.createTextNode("Input your answer");
          ...
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("label");
          dom.setAttribute(el4,"for","answerAuthor");
          var el5 = dom.createTextNode("You name");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
        ...
        statements: [
          ["inline","input",[],["value",["subexpr","@mut",[["get","answerContent",["loc",[null,[6,24],[6,37]]]]],[],[]],"id","answerContent","class","form-control"],["loc",[null,[6,10],[6,79]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","answerAuthor",["loc",[null,[11,24],[11,36]]]]],[],[]],"id","answerAuthor","class","form-control"],["loc",[null,[11,10],[11,77]]]],
          ["element","action",["saveAnswer"],[],["loc",[null,[14,34],[14,57]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child1 = (function() {
      return {
        ...
        statements: [
          ["element","action",["answerFormShow"],[],["loc",[null,[18,30],[18,57]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","addNewAnswer",["loc",[null,[1,6],[1,18]]]]],[],0,1,["loc",[null,[1,0],[19,7]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
...
define('qa-board/templates/components/new-question', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/new-question.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("label");
          dom.setAttribute(el4,"for","questionAuthor");
          var el5 = dom.createTextNode("Author's name");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("button");
          dom.setAttribute(el3,"class","btn-success");
          var el4 = dom.createTextNode("Save question");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n      ");
          dom.appendChild(el2, el3);
        ...
        statements: [
          ["inline","input",[],["value",["subexpr","@mut",[["get","content",["loc",[null,[7,24],[7,31]]]]],[],[]],"id","content"],["loc",[null,[7,10],[7,46]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","questionAuthor",["loc",[null,[12,24],[12,38]]]]],[],[]],"id","questionAuthor"],["loc",[null,[12,10],[12,60]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","description",["loc",[null,[17,24],[17,35]]]]],[],[]],"id","description"],["loc",[null,[17,10],[17,54]]]],
          ["element","action",["saveQuestion"],[],["loc",[null,[20,36],[20,61]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child1 = (function() {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          var el2 = dom.createTextNode("Add new question");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
        ...
        statements: [
          ["element","action",["questionFormShow"],[],["loc",[null,[24,30],[24,59]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","addNewQuestion",["loc",[null,[1,6],[1,20]]]]],[],0,1,["loc",[null,[1,0],[25,7]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
...
define('qa-board/templates/components/question-detail', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/question-detail.hbs"
        },
        arity: 1,
        cachedFragment: null,
        hasRendered: false,
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1,"class","answerBox");
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("ul");
          var el3 = dom.createTextNode("\n    ");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("li");
          dom.setAttribute(el3,"class","answer");
          ...
          var el5 = dom.createTextNode("Submitted by:");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("strong");
          ...
          var el6 = dom.createTextNode("Vote results: ");
          ...
          dom.setAttribute(el4,"class","glyphicon glyphicon-thumbs-up");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n    ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("button");
          dom.setAttribute(el4,"class","glyphicon glyphicon-thumbs-down");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n    ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("button");
          var el5 = dom.createTextNode("Delete asnwer");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n    ");
          dom.appendChild(el3, el4);
        ...
        statements: [
          ["content","answer.answerContent",["loc",[null,[22,62],[22,86]]]],
          ["content","answer.answerAuthor",["loc",[null,[22,143],[22,166]]]],
          ["inline","format-date",[["get","answer.date_added",["loc",[null,[22,225],[22,242]]]]],[],["loc",[null,[22,211],[22,244]]]],
          ["content","answer.votes",["loc",[null,[23,30],[23,46]]]],
          ["element","action",["voteUpAnswer",["get","answer",["loc",[null,[24,74],[24,80]]]]],[],["loc",[null,[24,50],[24,82]]]],
          ["element","action",["voteDownAnswer",["get","answer",["loc",[null,[25,78],[25,84]]]]],[],["loc",[null,[25,52],[25,86]]]],
          ["element","action",["deleteAnswer",["get","answer",["loc",[null,[26,36],[26,42]]]]],[],["loc",[null,[26,12],[26,44]]]]
        ],
        locals: ["answer"],
        templates: []
      };
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("div");
        dom.setAttribute(el1,"class","col-md-5 well");
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        ...
        dom.setAttribute(el3,"class","one");
        var el4 = dom.createComment("");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        ...
        dom.setAttribute(el2,"class","btn-danger");
        var el3 = dom.createTextNode("Delete question");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        ...
        var el3 = dom.createTextNode("Add new answer to this question!");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h4");
        var el3 = dom.createTextNode("Answers by other users:");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ["content","question.content",["loc",[null,[2,32],[2,52]]]],
        ["content","question.questionAuthor",["loc",[null,[3,12],[3,39]]]],
...
define('qa-board/templates/components/question-tile', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/question-tile.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
        ...
        statements: [
          ["content","question.content",["loc",[null,[1,47],[1,67]]]],
          ["content","question.questionAuthor",["loc",[null,[1,71],[1,98]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ["block","link-to",["question",["get","question.id",["loc",[null,[1,34],[1,45]]]]],[],0,null,["loc",[null,[1,12],[1,110]]]]
      ],
      locals: [],
      templates: [child0]
    };
...
define('qa-board/templates/components/update-question', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/components/update-question.hbs"
        },
        arity: 0,
        cachedFragment: null,
        hasRendered: false,
        ...
        statements: [
          ["content","question.content",["loc",[null,[4,13],[4,33]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","content",["loc",[null,[9,24],[9,31]]]]],[],[]],"id","content","placeholder",["subexpr","@mut",[["get","question.content",["loc",[null,[9,57],[9,73]]]]],[],[]]],["loc",[null,[9,10],[9,75]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","questionAuthor",["loc",[null,[14,24],[14,38]]]]],[],[]],"id","questionAuthor","placeholder",["subexpr","@mut",[["get","question.questionAuthor",["loc",[null,[14,71],[14,94]]]]],[],[]]],["loc",[null,[14,10],[14,96]]]],
          ["inline","input",[],["value",["subexpr","@mut",[["get","description",["loc",[null,[19,24],[19,35]]]]],[],[]],"id","description","placeholder",["subexpr","@mut",[["get","question.description",["loc",[null,[19,65],[19,85]]]]],[],[]]],["loc",[null,[19,10],[19,87]]]],
          ["element","action",["updateQuestion",["get","question",["loc",[null,[22,61],[22,69]]]]],[],["loc",[null,[22,35],[22,71]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child1 = (function() {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("button");
          dom.setAttribute(el1,"class","btn-warning btn-block");
          var el2 = dom.createTextNode("Update Question");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
        ...
        statements: [
          ["element","action",["updateQuestionForm"],[],["loc",[null,[26,40],[26,71]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","updateQuestionForm",["loc",[null,[3,6],[3,24]]]]],[],0,1,["loc",[null,[3,0],[27,7]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
...
define('qa-board/templates/index', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "qa-board/templates/index.hbs"
        },
        arity: 1,
        cachedFragment: null,
        hasRendered: false,
        ...
        statements: [
          ["inline","question-tile",[],["question",["subexpr","@mut",[["get","question",["loc",[null,[8,29],[8,37]]]]],[],[]],"deleteQuestion","deleteQuestion"],["loc",[null,[8,4],[8,71]]]]
        ],
        locals: ["question"],
        templates: []
      };
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Welcome to our Question and Answer Board!");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("h4");
        var el2 = dom.createTextNode(" Today is ");
        dom.appendChild(el1, el2);
        var el2 = dom.createComment("");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        ...
        var el2 = dom.createTextNode("List of available questions");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
      ...
      statements: [
        ["content","current-date",["loc",[null,[2,14],[2,30]]]],
        ["block","each",[["get","model",["loc",[null,[7,10],[7,15]]]]],[],0,null,["loc",[null,[7,2],[9,11]]]],
        ["inline","new-question",[],["saveQuestion","saveQuestion"],["loc",[null,[12,0],[12,44]]]]
      ],
      locals: [],
      templates: [child0]
    };
...
define('qa-board/templates/question', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "qa-board/templates/question.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
      ...
      statements: [
        ["inline","question-detail",[],["question",["subexpr","@mut",[["get","model",["loc",[null,[1,27],[1,32]]]]],[],[]],"saveAnswer","saveAnswer","deleteQuestion","deleteQuestion","deleteAnswer","deleteAnswer","voteUpAnswer","voteUpAnswer","voteDownAnswer","voteDownAnswer"],["loc",[null,[1,0],[1,178]]]],
        ["inline","update-question",[],["updateQuestion","updateQuestion","question",["subexpr","@mut",[["get","model",["loc",[null,[2,59],[2,64]]]]],[],[]]],["loc",[null,[2,0],[2,66]]]]
      ],
      locals: [],
      templates: []
    };
...
define('qa-board/tests/adapters/application.jshint', function () {
...
define('qa-board/tests/app.jshint', function () {
...
define('qa-board/tests/components/new-answer.jshint', function () {
...
define('qa-board/tests/components/new-question.jshint', function () {
...
define('qa-board/tests/components/question-detail.jshint', function () {
...
define('qa-board/tests/components/question-tile.jshint', function () {
...
define('qa-board/tests/components/update-question.jshint', function () {
...
define('qa-board/tests/helpers/current-date.jshint', function () {
...
define('qa-board/tests/helpers/format-date.jshint', function () {
...
define('qa-board/tests/helpers/resolver', ['exports', 'ember/resolver', 'qa-board/config/environment'], function (exports, Resolver, config) {
...
define('qa-board/tests/helpers/resolver.jshint', function () {
...
define('qa-board/tests/helpers/start-app', ['exports', 'ember', 'qa-board/app', 'qa-board/config/environment'], function (exports, Ember, Application, config) {
...
define('qa-board/tests/helpers/start-app.jshint', function () {
...
define('qa-board/tests/integration/components/answer-tile-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('answer-tile', 'Integration | Component | answer tile', {
    integration: true
  });
...
define('qa-board/tests/integration/components/answer-tile-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/answer-tile-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/answer-tile-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/integration/components/new-answer-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('new-answer', 'Integration | Component | new answer', {
    integration: true
  });
...
define('qa-board/tests/integration/components/new-answer-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/new-answer-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/new-answer-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/integration/components/new-question-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('new-question', 'Integration | Component | new question', {
    integration: true
  });
...
define('qa-board/tests/integration/components/new-question-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/new-question-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/new-question-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/integration/components/question-detail-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('question-detail', 'Integration | Component | question detail', {
    integration: true
  });
...
define('qa-board/tests/integration/components/question-detail-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/question-detail-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/question-detail-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/integration/components/question-tile-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('question-tile', 'Integration | Component | question tile', {
    integration: true
  });
...
define('qa-board/tests/integration/components/question-tile-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/question-tile-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/question-tile-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/integration/components/update-question-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForComponent('update-question', 'Integration | Component | update question', {
    integration: true
  });
...
define('qa-board/tests/integration/components/update-question-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/update-question-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'integration/components/update-question-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/models/answer.jshint', function () {
...
define('qa-board/tests/models/question.jshint', function () {
...
define('qa-board/tests/router.jshint', function () {
...
define('qa-board/tests/routes/about.jshint', function () {
...
define('qa-board/tests/routes/index.jshint', function () {
...
define('qa-board/tests/routes/question.jshint', function () {
...
define('qa-board/tests/test-helper', ['qa-board/tests/helpers/resolver', 'ember-qunit'], function (resolver, ember_qunit) {
...
define('qa-board/tests/test-helper.jshint', function () {
...
define('qa-board/tests/unit/helpers/current-date-test', ['qa-board/helpers/current-date', 'qunit'], function (current_date, qunit) {

  'use strict';

  qunit.module('Unit | Helper | current date');

  // Replace this with your real tests.
  qunit.test('it works', function (assert) {
    var result = current_date.currentDate(42);
    assert.ok(result);
  });

});
define('qa-board/tests/unit/helpers/current-date-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - unit/helpers');
  QUnit.test('unit/helpers/current-date-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'unit/helpers/current-date-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/unit/helpers/format-date-test', ['qa-board/helpers/format-date', 'qunit'], function (format_date, qunit) {
...
define('qa-board/tests/unit/helpers/format-date-test.jshint', function () {
...
define('qa-board/tests/unit/models/answer-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForModel('answer', 'Unit | Model | answer', {
...
define('qa-board/tests/unit/models/answer-test.jshint', function () {
...
define('qa-board/tests/unit/models/question-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForModel('question', 'Unit | Model | question', {
    // Specify the other units that are required for this test.
    needs: []
  });
...
define('qa-board/tests/unit/models/question-test.jshint', function () {
...
define('qa-board/tests/unit/routes/about-test', ['ember-qunit'], function (ember_qunit) {
...
define('qa-board/tests/unit/routes/about-test.jshint', function () {
...
define('qa-board/tests/unit/routes/answer-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:answer', 'Unit | Route | answer', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('qa-board/tests/unit/routes/answer-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - unit/routes');
  QUnit.test('unit/routes/answer-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'unit/routes/answer-test.js should pass jshint.'); 
  });

});
define('qa-board/tests/unit/routes/index-test', ['ember-qunit'], function (ember_qunit) {
...
define('qa-board/tests/unit/routes/index-test.jshint', function () {
...
define('qa-board/tests/unit/routes/question-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:question', 'Unit | Route | question', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('qa-board/tests/unit/routes/question-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - unit/routes');
  QUnit.test('unit/routes/question-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'unit/routes/question-test.js should pass jshint.'); 
  });

});
define('qa-board/torii-providers/firebase', ['exports', 'emberfire/torii-providers/firebase'], function (exports, FirebaseProvider) {
...
define('qa-board/config/environment', ['ember'], function(Ember) {
  var prefix = 'qa-board';
/* jshint ignore:start */
